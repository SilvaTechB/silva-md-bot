...
let handler = async (m, { conn, command, text, usedPrefix }) => {
  ...
  try {
    ...
    const captvid = '*FOLLOW 𝐒𝐈𝐋𝐕𝐀 𝐌𝐃 𝐁𝐎𝐓 support CHANNEL, AN ERROR OCCURRED TRY AGAIN AFTER 3 MONTHS YOU HAVE BEEN SUSPENDED FOR THAT DURATION FOR NOT FOLLOWING INSTRUCTIONS. keep loving 𝐒𝐈𝐋𝐕𝐀 𝐌𝐃 𝐁𝐎𝐓*';

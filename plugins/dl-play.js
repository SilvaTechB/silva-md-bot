...
⬡ Upload: ${ago}
⬡ Link: ${url}
╰────────⬣`, author.trim(), await( await conn.getFile(thumbnail)).data, ['VIDEO', `${usedPrefix}ytmp4 ${url}`], false, { quoted: m, 'document': { 'url':'https://whatsapp.com/channel/0029VaAkETLLY6d8qhLmZt2v' },
'mimetype': global.dpdf,
'fileName': `𝐒𝐈𝐋𝐕𝐀 𝐌𝐃 𝐁𝐎𝐓`,
...
body: wm,
sourceUrl: 'https://whatsapp.com/channel/0029VaAkETLLY6d8qhLmZt2v', thumbnail: await ( await conn.getFile(thumbnail)).data
  }
 } 
})

...
module.exports = {
    ...
    run: async (sock, message, args, ctx) => {
        ...
        if (!isAdmin) {
            return sock.sendMessage(jid, { text: theme.admin || '⛔ Only admins can lock or unlock the group.', contextInfo }, { quoted: message });
        }
        if (!isBotAdmin) {
            return sock.sendMessage(jid, { text: theme.botAdmin || '⛔ I need to be an admin to change group settings.', contextInfo }, { quoted: message });
        }
